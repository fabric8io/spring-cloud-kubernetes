...
Individual properties work fine for most cases but sometimes we find that yaml is more convinient. In this case we will use a single property named `application.yaml` and embed our yaml inside it:
